...
variable "rsv_vm_backup_name" {
  description = "Set the name of the daily vm backup policy"
  type = string
  default = "DefaultDailyBackup-VM"
}

variable "backup_timezone" {
  description = "Set the timezone for the backup schedule"
  type = string
  default = "GMT"
}